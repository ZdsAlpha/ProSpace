...
public class EnemyAnimation : MonoBehaviour
{
    ...
    public Vector2 m_AttackScaleMuti;
    public Vector2 m_AttackRotationMuti;
    public Color m_HPColorGreen;
    public Color m_HPColorRed;
    private string m_MovingKey = "Moving";
